...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + MonitorExtension.NAMESPACE + "\">" +
                        "</subsystem>";
        ...
        Assert.assertEquals(MonitorExtension.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(MonitorExtension.SUBSYSTEM_NAME));
    }
